...
def draw_caption(image, box, caption):
    ...
    """
    b = np.array(box).astype(int)
    cv2.putText(image, caption, (b[0], int((b[1]+b[3])/2)), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 0, 0), 2, lineType = cv2.LINE_AA)
    cv2.putText(image, caption, (b[0], int((b[1]+b[3])/2)), cv2.FONT_HERSHEY_DUPLEX, 1, (255, 255, 255), 1, lineType = cv2.LINE_AA)
